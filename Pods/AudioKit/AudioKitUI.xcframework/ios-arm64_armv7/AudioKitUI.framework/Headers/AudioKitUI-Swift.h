...
SWIFT_CLASS("_TtC10AudioKitUI15AKMIDITrackView")
@interface AKMIDITrackView : AKButton
...
SWIFT_CLASS("_TtC10AudioKitUI15AKWaveformLayer")
@interface AKWaveformLayer : CAShapeLayer
